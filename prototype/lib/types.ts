...
export interface CatalogueUnit { nativeFaction?:string; factionKeywords?:string; id: string; name: string; faction: string; url: string; aliases?: string[]; sizes?:import('./roster').SizeCost[]; pointsRetrievedAt?:string; image?:UnitImageReference }
