export interface UnitImageReference {url:string;source:string;originalUrl?:string;sha256?:string;credit:string;kind:'miniature';background:'white'|'transparent';verifiedAt:string}
