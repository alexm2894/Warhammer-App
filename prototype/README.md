...
- **Rule cards:** army rules, detachment rules and individual stratagems use shared reference cards. Select a detachment to show its stratagems. Rule packs are cached for the browser session; Refresh retrieves source updates. Dates and fallback warnings remain visible.
